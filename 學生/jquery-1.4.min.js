...
(function (A, w) {
    ...
    c.extend({
        ...
        uaMatch: function (a) {
            var b = { browser: '' };
            a = a.toLowerCase();
            if (/webkit/.test(a)) b = { browser: 'webkit', version: /webkit[\/ ]([\w.]+)/ };
            else if (/opera/.test(a))
                b = { browser: 'opera', version: /version/.test(a) ? /version[\/ ]([\w.]+)/ : /opera[\/ ]([\w.]+)/ };
            else if (/msie/.test(a)) b = { browser: 'msie', version: /msie ([\w.]+)/ };
            else if (/mozilla/.test(a) && !/compatible/.test(a)) b = { browser: 'mozilla', version: /rv:([\w.]+)/ };
            ...
            if (q.length > 1 && t.exec(g))
                ...
                if (h) {
                    v = m
                        ...
                        : p.find(
                              q.pop(),
                              q.length === 1 && (q[0] === '~' || q[0] === '+') && h.parentNode ? h.parentNode : h,
                              N,
                          );
                ...
                n.find.ID = function (m, r, q) {
                    if (typeof r.getElementById !== 'undefined' && !q)
                        return (r = r.getElementById(m[1]))
                            ? r.id === m[1] ||
                              (typeof r.getAttributeNode !== 'undefined' && r.getAttributeNode('id').nodeValue === m[1])
                                ? [r]
                                : w
                            : [];
                };
            ...
            if (this[0]) {
                ...
                if ((i = e.fragment.firstChild)) {
                    ...
                    for (var p = 0, n = this.length; p < n; p++)
                        d.call(
                            b ? f(this[p], i) : this[p],
                            e.cacheable || this.length > 1 || p > 0 ? e.fragment.cloneNode(true) : e.fragment,
                        );
                }
                o && c.each(o, La);
            }
            ...
            if (d)
                for (a = 0; e[a]; a++)
                    if (
                        ...
                        e[a].nodeType === 1 &&
                            e.splice.apply(e, [a + 1, 0].concat(c.makeArray(e[a].getElementsByTagName('script'))));
                        d.appendChild(e[a]);
                    }
            return e;
        },
    ...
    c.fn.extend({
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                .filter(function () {
                    return (
                        this.name && !this.disabled && (this.checked || sb.test(this.nodeName) || tb.test(this.type))
                    );
                })
                .map(function (a, b) {
                    a = c(this).val();
